...
namespace GB_ASP
{
    public partial class ChequeReceivedReport : System.Web.UI.Page
    {
        ...
        public void BindGrid4()
        {
            ...
            foreach (System.Web.UI.WebControls.ListItem item in multiselect4.Items)
            {
                ...
                if (condition == "")
                {
                    inputReceivedFrom.Value = condition;
                    // TextBox1.Text = condition;
                }
                else
                {
                    inputReceivedFrom.Value = condition.Substring(0, condition.Length - 1);
                }
...

        {
            ...
            { 
            GridView1.DataSource = ChequeReceivedReportList.GetChequeReceivedReport(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value,Session["Branch"].ToString(),inputReceivedFrom.Value, Session["Division"].ToString(),  out totalRows);
            }
            //else if (User == FTD)
            //{
            //    GridView1.DataSource = ChequeReceivedReportList.GetChequeReceivedReport(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, inputBranch.Value, inputReceivedFrom.Value, "FEED TECH DIVISION", out totalRows);
            //}
            //else if (User == PHD)
            //{
            //    GridView1.DataSource = ChequeReceivedReportList.GetChequeReceivedReport(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, inputBranch.Value, inputReceivedFrom.Value, "POULTRY HEALTH DIVISION", out totalRows);
            //}
            //else if (User == SPD)
            //{
            //    GridView1.DataSource = ChequeReceivedReportList.GetChequeReceivedReport(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, inputBranch.Value, inputReceivedFrom.Value, "SPECIALITY PRODUCT DIVISION", out totalRows);
            //}
            //else if (User == HHD)
            //{
            //    GridView1.DataSource = ChequeReceivedReportList.GetChequeReceivedReport(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, inputBranch.Value, inputReceivedFrom.Value, "HUMAN HEALTH DIVISION", out totalRows);
            //}
            //else if (User == Mudassir)
            //{
            //    GridView1.DataSource = ChequeReceivedReportList.GetChequeReceivedReport(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value,"KHO,HDC", inputReceivedFrom.Value, "FEED TECH DIVISION", out totalRows);
            //}
            //else if (User == Amir)
            //{
            //    GridView1.DataSource = ChequeReceivedReportList.GetChequeReceivedReport(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, "KHO,HDC", inputReceivedFrom.Value, "POULTRY HEALTH DIVISION", out totalRows);
            //}
            //else if (User == Arshad)
            //{
            //    GridView1.DataSource = ChequeReceivedReportList.GetChequeReceivedReport(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, "KHO", inputReceivedFrom.Value, "SPECIALITY PRODUCT DIVISION", out totalRows);
            //}
            else
            {
                GridView1.DataSource = ChequeReceivedReportList.GetChequeReceivedReport(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, inputBranch.Value, inputReceivedFrom.Value, inputDivision.Value, out totalRows);
            }
            GridView1.DataBind();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (Session["User"].ToString().ToUpper() != "ADMIN")
            {
                GridView1.DataSource = ChequeReceivedReportList.GetChequeReceivedReport(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, Session["Branch"].ToString(), inputReceivedFrom.Value, Session["Division"].ToString(), out totalRows);
            }
            //else if (User == FTD)
            //{
            //    GridView1.DataSource = ChequeReceivedReportList.GetChequeReceivedReport(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, inputBranch.Value, inputReceivedFrom.Value, "FEED TECH DIVISION", out totalRows);
            //}
            //else if (User == PHD)
            //{
            //    GridView1.DataSource = ChequeReceivedReportList.GetChequeReceivedReport(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, inputBranch.Value, inputReceivedFrom.Value, "POULTRY HEALTH DIVISION", out totalRows);
            //}
            //else if (User == SPD)
            //{
            //    GridView1.DataSource = ChequeReceivedReportList.GetChequeReceivedReport(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, inputBranch.Value, inputReceivedFrom.Value, "SPECIALITY PRODUCT DIVISION", out totalRows);
            //}
            //else if (User == HHD)
            //{
            //    GridView1.DataSource = ChequeReceivedReportList.GetChequeReceivedReport(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, inputBranch.Value, inputReceivedFrom.Value, "HUMAN HEALTH DIVISION", out totalRows);
            //}
            //else if (User == Mudassir)
            //{
            //    GridView1.DataSource = ChequeReceivedReportList.GetChequeReceivedReport(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, "KHO,HDC", inputReceivedFrom.Value, "FEED TECH DIVISION", out totalRows);
            //}
            //else if (User == Amir)
            //{
            //    GridView1.DataSource = ChequeReceivedReportList.GetChequeReceivedReport(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, "KHO,HDC", inputReceivedFrom.Value, "POULTRY HEALTH DIVISION", out totalRows);
            //}
            //else if (User == Arshad)
            //{
            //    GridView1.DataSource = ChequeReceivedReportList.GetChequeReceivedReport(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, "KHO", inputReceivedFrom.Value, "SPECIALITY PRODUCT DIVISION", out totalRows);
            //}
            else
            {
                GridView1.DataSource = ChequeReceivedReportList.GetChequeReceivedReport(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, inputBranch.Value, inputReceivedFrom.Value, inputDivision.Value, out totalRows);
            }
            GridView1.DataBind();
        ...
        protected void ExpToExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("content-disposition", "attachment; filename=ChequeReceivedReport.xls");
        ...
        {
            {
                ...
                Response.AppendHeader("content-disposition",
                    "attachment;filename=ChequeReceivedReport.pdf");
