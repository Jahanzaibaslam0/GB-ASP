<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ALLSALESORDER.aspx.cs" Inherits="GB_ASP.ALLSALESORDER" %>
...
<body>
 ...
 <div id="wrapper" >
        ...
        <div class="panel panel-primary">
            ...
            <asp:GridView ID="GridView1" CssClass="table table-bordered" runat="server" AllowPaging="True" BackColor="White" PagerSettings-FirstPageText="First" PagerSettings-Mode="NumericFirstLast" PagerSettings-LastPageText="Last" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" PageSize="10">
