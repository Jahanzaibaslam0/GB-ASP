<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OpenSalesOrderForCustomerOnHold.aspx.cs" Inherits="GB_ASP.OpenSalesOrderForCustomerOnHold" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>OPEN SALES ORDER FOR CUSTOMER ON HOLD</title>
 ...
 <div id="wrapper" >
                       ...
                       <li >
                        ...
                        <li >
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a  href="MonthWiseItemSales.aspx">MONTH WISE ITEM SALES</a>
                                    </li>
                                    <li>
                ...
                <div class="row">
                    <div class="col-md-3">
                         ...
                         <input type="text" runat="server" Class="form-control" 
                                id="inputSalesOrder" placeholder="Sales Order ID" />
                        </div>
                            </div>
                         ...
                         <input type="text" runat="server" Class="form-control" visible="false"
                                id="inputCretedBy" placeholder="Created By" />
                        
                         <input type="text" runat="server" Class="form-control"
                                id="inputStatus" placeholder="Status" visible="false" />
                    ...
                    <div class="col-md-3">
                     ...
                     <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <asp:ListBox ID="multiselect2" runat="server" AutoPostBack="false" Visible="false"  SelectionMode="Multiple" OnSelectedIndexChanged="multiselect2_SelectedIndexChanged">        
        ...
        <div class="panel panel-primary">
                <div class="panel-heading">
                    OPEN SALES ORDER FOR CUSTOMER ON HOLD 
                </div>
