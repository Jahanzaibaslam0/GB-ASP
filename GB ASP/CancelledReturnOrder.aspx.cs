...
namespace GB_ASP
{
    public partial class CancelledReturnOrder : System.Web.UI.Page
    {
...

        {
            ...
            { 
            GridView1.DataSource = ReturnOrder.GetReturnOrder(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, Session["Division"].ToString(), inputSalesID.Value, inputSalesTaker.Value, Session["Branch"].ToString(), "4", out totalRows);
            }
            //else if (User == FTD)
            //{
            //    GridView1.DataSource = ReturnOrder.GetReturnOrder(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, "FEED TECH DIVISION", inputSalesID.Value, inputSalesTaker.Value, inputBranch.Value, "4", out totalRows);
            //}
            //else if (User == PHD)
            //{
            //    GridView1.DataSource = ReturnOrder.GetReturnOrder(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, "POULTRY HEALTH DIVISION", inputSalesID.Value, inputSalesTaker.Value, inputBranch.Value, "4", out totalRows);
            //}
            //else if (User == SPD)
            //{
            //    GridView1.DataSource = ReturnOrder.GetReturnOrder(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, "SPECIALITY PRODUCT DIVISION", inputSalesID.Value, inputSalesTaker.Value, inputBranch.Value, "4", out totalRows);
            //}
            //else if (User == HHD)
            //{
            //    GridView1.DataSource = ReturnOrder.GetReturnOrder(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, "HUMAN HEALTH DIVISION", inputSalesID.Value, inputSalesTaker.Value, inputBranch.Value, "4", out totalRows);
            //}
            //else if (User == Mudassir)
            //{
            //    GridView1.DataSource = ReturnOrder.GetReturnOrder(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, "FEED TECH DIVISION", inputSalesID.Value, inputSalesTaker.Value,"KHO,HDC", "4", out totalRows);

            //}
            //else if (User == Amir)
            //{
            //    GridView1.DataSource = ReturnOrder.GetReturnOrder(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, "POULTRY HEALTH DIVISION", inputSalesID.Value, inputSalesTaker.Value,"KHO,HDC", "4", out totalRows);
            //}
            //else if (User == Arshad)
            //{
            //    GridView1.DataSource = ReturnOrder.GetReturnOrder(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, "SPECIALITY PRODUCT DIVISION", inputSalesID.Value, inputSalesTaker.Value, "KHO", "4", out totalRows);
            //}
            else
            {
                GridView1.DataSource = ReturnOrder.GetReturnOrder(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, inputDivision.Value, inputSalesID.Value, inputSalesTaker.Value, inputBranch.Value, "4", out totalRows);
            }
            GridView1.DataBind();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (Session["User"].ToString().ToUpper() != "ADMIN")
            {
                GridView1.DataSource = ReturnOrder.GetReturnOrder(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, Session["Division"].ToString(), inputSalesID.Value, inputSalesTaker.Value, Session["Branch"].ToString(), "4", out totalRows);
            }
            //else if (User == FTD)
            //{
            //    GridView1.DataSource = ReturnOrder.GetReturnOrder(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, "FEED TECH DIVISION", inputSalesID.Value, inputSalesTaker.Value, inputBranch.Value, "4", out totalRows);
            //}
            //else if (User == PHD)
            //{
            //    GridView1.DataSource = ReturnOrder.GetReturnOrder(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, "POULTRY HEALTH DIVISION", inputSalesID.Value, inputSalesTaker.Value, inputBranch.Value, "4", out totalRows);
            //}
            //else if (User == SPD)
            //{
            //    GridView1.DataSource = ReturnOrder.GetReturnOrder(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, "SPECIALITY PRODUCT DIVISION", inputSalesID.Value, inputSalesTaker.Value, inputBranch.Value, "4", out totalRows);
            //}
            //else if (User == HHD)
            //{
            //    GridView1.DataSource = ReturnOrder.GetReturnOrder(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, "HUMAN HEALTH DIVISION", inputSalesID.Value, inputSalesTaker.Value, inputBranch.Value, "4", out totalRows);
            //}
            // else if (User == Mudassir)
            //{
            //    GridView1.DataSource = ReturnOrder.GetReturnOrder(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, "FEED TECH DIVISION", inputSalesID.Value, inputSalesTaker.Value,"KHO,HDC", "4", out totalRows);
            //}
            //else if (User == Amir)
            //{
            //    GridView1.DataSource = ReturnOrder.GetReturnOrder(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, "POULTRY HEALTH DIVISION", inputSalesID.Value, inputSalesTaker.Value,"KHO,HDC", "4", out totalRows);
            //}
            //else if (User == Arshad)
            //{
            //    GridView1.DataSource = ReturnOrder.GetReturnOrder(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, "SPECIALITY PRODUCT DIVISION", inputSalesID.Value, inputSalesTaker.Value, "KHO", "4", out totalRows);
            //}
            else
            {
                GridView1.DataSource = ReturnOrder.GetReturnOrder(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value, inputCustomerName.Value, inputDivision.Value, inputSalesID.Value, inputSalesTaker.Value, inputBranch.Value, "4", out totalRows);
            }
            GridView1.DataBind();
        ...
        protected void ExpToExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("content-disposition", "attachment; filename=CancelledReturnOrder.xls");
        ...
        {
            string attach = "attachment;filename=CloseReturnOrder.xls";
            Response.ClearContent();
        ...
        {
            {
                ...
                Response.AppendHeader("content-disposition",
                    "attachment;filename=CancelledReturnOrder.pdf");
