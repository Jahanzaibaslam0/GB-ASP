<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OpenCustomerInvoicePastDueToday.aspx.cs" Inherits="GB_ASP.OpenCustomerInvoicePastDueToday" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>OPEN CUSTOMER INVOICE PAST DUE TODAY</title>
            ...
            <div class="container-fluid">
               <br />
                ...
                <div class="row">
                  ...
                  <div class="form-group">--%>
                         <input type="text" runat="server" Class="form-control" visible="false"
                                id="inputSalesTaker" placeholder="Sales Taker" />
                       <%-- </div>
                        </div>
                  ...
                  <div class="form-group">--%>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                         <input type="text" runat="server" Class="form-control"
                                id="inputInvoice" placeholder="Invoice ID" />
                        </div>
                    </div>
    ...
    <%--                <div class="col-md-3">
        ...
        <div class="panel panel-primary">
                <div class="panel-heading">
                    OPEN CUSTOMER INVOICE PAST DUE TODAY
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#multiselect5').multiselect({
                nonSelectedText: 'Select SalesTaker!',
