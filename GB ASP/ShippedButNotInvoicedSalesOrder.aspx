<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShippedButNotInvoicedSalesOrder.aspx.cs" Inherits="GB_ASP.ShippedButNotInvoicedSalesOrder" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>SHIPPED BUT NOT INVOICED</title>
 ...
 <div id="wrapper" >
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" runat="server" Class="form-control" visible="false"
                         ...
                         <input type="text" runat="server" Class="form-control" visible="false"
                                id="txt_User" placeholder="Text User" />
        ...
        <div class="panel panel-primary">
                <div class="panel-heading">
                    SHIPPED BUT NOT INVOICED SALES ORDER
                </div>
