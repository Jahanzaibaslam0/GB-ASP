<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerWiseYearlySales.aspx.cs" Inherits="GB_ASP.CustomerWiseYearlySales" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CUSTOMER WISE YEARLY SALES</title>
               ...
               <br />
                ...
                <div class="row">
                         ...
                         <input type="text" runat="server" Class="form-control" visible="false"
                                id="inputCustomerID" placeholder="Customer ID" />
