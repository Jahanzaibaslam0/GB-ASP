<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerTest.aspx.cs" Inherits="GB_ASP.CustomerTest" %>
...
<div class="example">
 ...
 <div id="wrapper" >
                 ...
                 <%-- <asp:ListBox ID="multiselect12" runat="server" AutoPostBack="true" SelectionMode="Multiple" OnSelectedIndexChanged="ABCD"></asp:ListBox>--%>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-2">
                          <div class="form-group">
                         <input type="text" runat="server" Class="form-control"
                                id="txtReturnBranch" visible="true" />
                        </div>
                    </div>
        ...
        <div class="panel panel-primary">
            ...
            <asp:GridView ID="example" CssClass="table table-bordered" runat="server" AllowPaging="True" BackColor="White" PagerSettings-FirstPageText="First" PagerSettings-Mode="NumericFirstLast" PagerSettings-LastPageText="Last" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" PageSize="10">
           ...
           <img src="cloader4.gif" alt="" width="200" height="200" />
        </div>
