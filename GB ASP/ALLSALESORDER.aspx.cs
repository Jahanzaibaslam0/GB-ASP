...
namespace GB_ASP
{
    public partial class ALLSALESORDER : System.Web.UI.Page
    {
...

        {
            ...
            {
                GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(pageIndex, GridView1.PageSize, inputStatus.Value, inputHold.Value,Session["Branch"].ToString(), inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, Session["Division"].ToString(), inputRegion.Value, out totalRows);
            }
            //else if (User == FTD)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(pageIndex, GridView1.PageSize, inputStatus.Value, inputHold.Value, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "FEED TECH DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == PHD)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(pageIndex, GridView1.PageSize, inputStatus.Value, inputHold.Value, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "POULTRY HEALTH DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == SPD)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(pageIndex, GridView1.PageSize, inputStatus.Value, inputHold.Value, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "SPECIALITY PRODUCT DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == HHD)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(pageIndex, GridView1.PageSize, inputStatus.Value, inputHold.Value, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "HUMAN HEALTH DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == Mudassir)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(pageIndex, GridView1.PageSize, inputStatus.Value, inputHold.Value,"KHO,HDC",  inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "FEED TECH DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == Amir)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(pageIndex, GridView1.PageSize, inputStatus.Value, inputHold.Value, "KHO,HDC", inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "POULTRY HEALTH DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == Arshad)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(pageIndex, GridView1.PageSize, inputStatus.Value, inputHold.Value, "KHO", inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "SPECIALITY PRODUCT DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            else
            {
                GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(pageIndex, GridView1.PageSize, inputStatus.Value, inputHold.Value, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, inputDivision.Value, inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            }
            GridView1.DataBind();
        ...
        protected void ExpToExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("content-disposition", "attachment; filename=AllSALESORDER.xls");
        ...
        {
            {
                ...
                Response.AppendHeader("content-disposition",
                    "attachment;filename=AllSALESORDER.pdf");
