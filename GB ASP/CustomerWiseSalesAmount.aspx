<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerWiseSalesAmount.aspx.cs" Inherits="GB_ASP.CustomerWiseSalesAmount1" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>CUSTOMER WISE SALES AMOUNT</title>
               ...
               <br />
                ...
                <div class="row">
                         ...
                         <input type="text" runat="server" Class="form-control" visible="false"
                                id="inputCustomer" placeholder="CUSTOMER ID" />
                        
                         <input type="text" runat="server" Class="form-control" visible="false"
                                id="inputCustName" placeholder="CUSTOMER NAME" />
