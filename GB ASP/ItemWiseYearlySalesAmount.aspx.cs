...
namespace GB_ASP
{
    public partial class ItemWiseYearlySalesAmount1 : System.Web.UI.Page
    {
        ...
        public void BindGrid4()
        {
            ...
            foreach (System.Web.UI.WebControls.ListItem item in multiselect4.Items)
            {
                ...
                if (condition == "")
                {
                    inputTeam.Value = condition;
                    // TextBox1.Text = condition;
                }
                else
                {
                    inputTeam.Value = condition.Substring(0, condition.Length - 1);
                }
...

        {
            ...
            {
                GridView1.DataSource = ItemWiseYearlySalesAmount.GetItemWiseYearlySalesAmount(pageIndex, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, Session["Division"].ToString(), inputTeam.Value, out totalRows);
            }
            //if (User == FTD)
            //{
            //    GridView1.DataSource = ItemWiseYearlySalesAmount.GetItemWiseYearlySalesAmount(pageIndex, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "FEED TECH DIVISION", inputTeam.Value, out totalRows);
            //}
            //if (User == SPD)
            //{
            //    GridView1.DataSource = ItemWiseYearlySalesAmount.GetItemWiseYearlySalesAmount(pageIndex, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "SPECIALITY PRODUCT DIVISION", inputTeam.Value, out totalRows);
            //}
            //if (User == PHD)
            //{
            //    GridView1.DataSource = ItemWiseYearlySalesAmount.GetItemWiseYearlySalesAmount(pageIndex, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "POULTRY HEALTH DIVISION", inputTeam.Value, out totalRows);
            //}
            //if (User == HHD)
            //{
            //    GridView1.DataSource = ItemWiseYearlySalesAmount.GetItemWiseYearlySalesAmount(pageIndex, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "HUMAN HEALTH DIVISION", inputTeam.Value, out totalRows);
            //}
            else
            {
                GridView1.DataSource = ItemWiseYearlySalesAmount.GetItemWiseYearlySalesAmount(pageIndex, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, inputDivision.Value, inputTeam.Value, out totalRows);
            }
            GridView1.DataBind();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (Session["User"].ToString().ToUpper() != "ADMIN")
            {
                GridView1.DataSource = ItemWiseYearlySalesAmount.GetItemWiseYearlySalesAmount(0, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, Session["Division"].ToString(), inputTeam.Value, out totalRows);
            }
            //if (User == FTD)
            //{
            //    GridView1.DataSource = ItemWiseYearlySalesAmount.GetItemWiseYearlySalesAmount(0, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "FEED TECH DIVISION", inputTeam.Value, out totalRows);
            //}
            //if (User == SPD)
            //{
            //    GridView1.DataSource = ItemWiseYearlySalesAmount.GetItemWiseYearlySalesAmount(0, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "SPECIALITY PRODUCT DIVISION", inputTeam.Value, out totalRows);
            //}
            //if (User == PHD)
            //{
            //    GridView1.DataSource = ItemWiseYearlySalesAmount.GetItemWiseYearlySalesAmount(0, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "POULTRY HEALTH DIVISION", inputTeam.Value, out totalRows);
            //}
            //if (User == HHD)
            //{
            //    GridView1.DataSource = ItemWiseYearlySalesAmount.GetItemWiseYearlySalesAmount(0, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "HUMAN HEALTH DIVISION", inputTeam.Value, out totalRows);
            //}
            else
            {
                GridView1.DataSource = ItemWiseYearlySalesAmount.GetItemWiseYearlySalesAmount(0, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, inputDivision.Value, inputTeam.Value, out totalRows);
        ...
        {
            {
                ...
                Response.AppendHeader("content-disposition",
                    "attachment;filename=ItemWiseYearlySaleAmount.pdf");
