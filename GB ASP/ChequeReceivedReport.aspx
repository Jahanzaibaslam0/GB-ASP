<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChequeReceivedReport.aspx.cs" Inherits="GB_ASP.ChequeReceivedReport" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CHEQUE RECEIVED REPORT</title>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li >
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a  href="OpenCustomerInvoicePastDueToday.aspx">OPEN CUSTOMER INVOICE PAST DUE TODAY</a>
                                    </li>
                                    <li>
            ...
            <div class="container-fluid">
               <br />
                ...
                <div class="row">
                         ...
                         <input type="text" runat="server" Class="form-control" visible="false"
                                id="inputReceivedFrom" placeholder="Received From" />
                    ...
                    <%--<div class="col-md-2">
                        <div class="form-group">
                            <asp:Button ID="Button4" runat="server" Text="Export"  OnClick="btnDownload_Click"
                              CssClass="btn btn-primary"   />
                        </div>
                    </div>--%>
 ...
 <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('#multiselect4').multiselect({
                nonSelectedText: 'Select Received From!',
