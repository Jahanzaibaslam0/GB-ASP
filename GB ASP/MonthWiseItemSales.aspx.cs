...
namespace GB_ASP
{
    public partial class ItemWiseMonthlySales1 : System.Web.UI.Page
    {
...

        {
            ...
            {
                GridView1.DataSource = ItemWiseMonthlySales.GetMonthWiseItemSales(pageIndex, GridView1.PageSize,inputITEMID.Value,inputItemName.Value,inputRegion.Value, Session["Division"].ToString(), out totalRows);
            }
            //if (User == FTD)
            //{
            //    GridView1.DataSource = ItemWiseMonthlySales.GetMonthWiseItemSales(pageIndex, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "FEED TECH DIVISION", out totalRows);
            //}
            //if (User == SPD)
            //{
            //    GridView1.DataSource = ItemWiseMonthlySales.GetMonthWiseItemSales(pageIndex, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "SPECIALITY PRODUCT DIVISION", out totalRows);
            //}
            //if (User == PHD)
            //{
            //    GridView1.DataSource = ItemWiseMonthlySales.GetMonthWiseItemSales(pageIndex, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "POULTRY HEALTH DIVISION", out totalRows);
            //}
            //if (User == HHD)
            //{
            //    GridView1.DataSource = ItemWiseMonthlySales.GetMonthWiseItemSales(pageIndex, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "HUMAN HEALTH DIVISION", out totalRows);
            //}
            else
            {
                GridView1.DataSource = ItemWiseMonthlySales.GetMonthWiseItemSales(pageIndex, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, inputDivision.Value, out totalRows);
            }
            GridView1.DataBind();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (Session["User"].ToString().ToUpper() != "ADMIN")
            {
                GridView1.DataSource = ItemWiseMonthlySales.GetMonthWiseItemSales(0, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, Session["Division"].ToString(), out totalRows);
            }
            //if (User == FTD)
            //{
            //    GridView1.DataSource = ItemWiseMonthlySales.GetMonthWiseItemSales(0, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "FEED TECH DIVISION", out totalRows);
            //}
            //if (User == SPD)
            //{
            //    GridView1.DataSource = ItemWiseMonthlySales.GetMonthWiseItemSales(0, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "SPECIALITY PRODUCT DIVISION", out totalRows);
            //}
            //if (User == PHD)
            //{
            //    GridView1.DataSource = ItemWiseMonthlySales.GetMonthWiseItemSales(0, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "POULTRY HEALTH DIVISION", out totalRows);
            //}
            //if (User == HHD)
            //{
            //    GridView1.DataSource = ItemWiseMonthlySales.GetMonthWiseItemSales(0, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "HUMAN HEALTH DIVISION", out totalRows);
            //}
            else
            {
                GridView1.DataSource = ItemWiseMonthlySales.GetMonthWiseItemSales(0, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, inputDivision.Value, out totalRows);
        ...
        protected void ExpToExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("content-disposition", "attachment; filename=MonthWiseItemSales.xls");
        ...
        {
            {
                ...
                Response.AppendHeader("content-disposition",
                    "attachment;filename=MonthWiseItemSales.pdf");
