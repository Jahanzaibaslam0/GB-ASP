...
namespace GB_ASP
{
    public partial class COD1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string query4 = @"select distinct (Select top 1 DimensionFinancialTag.Description
...

        {
            ...
            {
                GridView1.DataSource = COD.GetCODLIST(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, Session["Branch"].ToString(), inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, Session["Division"].ToString(), inputRegion.Value, out totalRows);

            }
            //else if(User == AHD)
            //{ 
            //GridView1.DataSource = COD.GetCODLIST(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputBranch.Value, inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, "ANIMAL HEALTH DIVISION", inputRegion.Value, out totalRows);
            //}
            //else if (User == FTD)
            //{
            //    GridView1.DataSource = COD.GetCODLIST(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputBranch.Value, inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, "FEED TECH DIVISION", inputRegion.Value, out totalRows);
            //}
            //else if (User == PHD)
            //{
            //    GridView1.DataSource = COD.GetCODLIST(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputBranch.Value, inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, "POULTRY HEALTH DIVISION", inputRegion.Value, out totalRows);
            //}
            //else if (User == SPD)
            //{
            //    GridView1.DataSource = COD.GetCODLIST(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputBranch.Value, inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, "SPECIALITY PRODUCT DIVISION", inputRegion.Value, out totalRows);
            //}
            //else if (User == HHD)
            //{
            //    GridView1.DataSource = COD.GetCODLIST(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputBranch.Value, inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, "HUMAN HEALTH DIVISION", inputRegion.Value, out totalRows);
            //}
            //else if (User == Mudassir)
            //{
            //    GridView1.DataSource = COD.GetCODLIST(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, "KHO,LDC", inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, "FEED TECH DIVISION", inputRegion.Value, out totalRows);
            //}
            //else if (User == Amir)
            //{
            //    GridView1.DataSource = COD.GetCODLIST(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, "KHO,LDC", inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, "POULTRY HEALTH DIVISION", inputRegion.Value, out totalRows);
            //}
            //else if (User == Arshad)
            //{
            //    GridView1.DataSource = COD.GetCODLIST(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, "KHO", inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, "SPECIALITY PRODUCT DIVISION", inputRegion.Value, out totalRows);
            //}
            else
            {
                GridView1.DataSource = COD.GetCODLIST(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputBranch.Value, inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            }
            GridView1.DataBind();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (Session["User"].ToString().ToUpper() != "ADMIN")
            {
                GridView1.DataSource = COD.GetCODLIST(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, Session["Branch"].ToString(), inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, Session["Division"].ToString(), inputRegion.Value, out totalRows);

            }
            //else if (User == AHD)
            //{
            //    GridView1.DataSource = COD.GetCODLIST(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputBranch.Value, inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, "ANIMAL HEALTH DIVISION", inputRegion.Value, out totalRows);
            //}
            //else if (User == FTD)
            //{
            //    GridView1.DataSource = COD.GetCODLIST(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputBranch.Value, inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, "FEED TECH DIVISION", inputRegion.Value, out totalRows);
            //}
            //else if (User == PHD)
            //{
            //    GridView1.DataSource = COD.GetCODLIST(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputBranch.Value, inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, "POULTRY HEALTH DIVISION", inputRegion.Value, out totalRows);
            //}
            //else if (User == SPD)
            //{
            //    GridView1.DataSource = COD.GetCODLIST(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputBranch.Value, inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, "SPECIALITY PRODUCT DIVISION", inputRegion.Value, out totalRows);
            //}
            //else if (User == HHD)
            //{
            //    GridView1.DataSource = COD.GetCODLIST(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputBranch.Value, inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, "HUMAN HEALTH DIVISION", inputRegion.Value, out totalRows);
            //}
            //else if (User == Mudassir)
            //{
            //    GridView1.DataSource = COD.GetCODLIST(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value,"KHO,HDC",  inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, "FEED TECH DIVISION", inputRegion.Value, out totalRows);
            //}
            //else if (User == Amir)
            //{
            //    GridView1.DataSource = COD.GetCODLIST(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, "KHO,HDC", inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, "POULTRY HEALTH DIVISION", inputRegion.Value, out totalRows);
            //}
            //else if (User == Arshad)
            //{
            //    GridView1.DataSource = COD.GetCODLIST(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, "KHO", inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, "SPECIALITY PRODUCT DIVISION", inputRegion.Value, out totalRows);
            //}
            else
            {
                GridView1.DataSource = COD.GetCODLIST(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputBranch.Value, inputCustomerCode.Value, inputCustomerName.Value, inputInvoice.Value, inputSalesID.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            }
            GridView1.DataBind();
        ...
        protected void ExpToExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("content-disposition", "attachment; filename=COD.xls");
