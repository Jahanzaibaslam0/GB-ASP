...
namespace GB_ASP
{
    public partial class OpenCustomerInvoicePastDueToday : System.Web.UI.Page
    {
        ...
        protected void ExpToExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("content-disposition", "attachment; filename=OpenCustInvoiceDueToday.xls");
        ...
        {
            {
                ...
                Response.AppendHeader("content-disposition",
                    "attachment;filename=OpenCustInvoiceDueToday.pdf");
