<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllCustomerOnHold.aspx.cs" Inherits="GB_ASP.AllCustomerOnHold" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ALL CUSTOMER ON HOLD</title>
 ...
 <div id="wrapper" >
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"> <img style="width:70px; margin-bottom: 10px" src="Images/GB-Logo.png" alt="GhaziBorthers" ></a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div class="panel panel-primary">
            ...
            <asp:GridView ID="example" CssClass="table table-bordered" runat="server" AllowPaging="True" BackColor="White" PagerSettings-FirstPageText="First" PagerSettings-Mode="Numeric" PagerSettings-LastPageText="Last" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" PageSize="50">
