<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="GB_ASP.Index" %>
                   ...
                   <%--         <asp:DropDownList ID="DropDownList1" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" DataSourceID="SqlDataSource1" DataTextField="ITEMID" DataValueField="ITEMID"></asp:DropDownList>
                    ...
                    --%>    <%--                        <div class="row">
                        <div class="col-lg-6">
                             ...
                             <div class="table-responsive">                            
                                 <asp:GridView ID="GridView1" OnPageIndexChanging="GridView1_PageIndexChanging" runat="server" CssClass="table-responsive" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
