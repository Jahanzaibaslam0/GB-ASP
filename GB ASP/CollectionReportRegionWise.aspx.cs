...
namespace GB_ASP
{
    public partial class CollectionReportRegionWise : System.Web.UI.Page
    {
        ...
        public void BindGrid4()
        {
            ...
            foreach (System.Web.UI.WebControls.ListItem item in multiselect4.Items)
            {
                ...
                if (condition == "")
                {
                    inputYear.Value = condition;
                    // TextBox1.Text = condition;
                }
                else
                {
                    inputYear.Value = condition.Substring(0, condition.Length - 1);
                }
...

        {
            ...
            string SPD = "SPD";
            string FTD = "FTD";
            string abc = Properties.Settings.Default.Division;
            string PHD = "PHD";
            string HHD = "HHD";
            ...
            { 
                GridView1.DataSource = CollectionReportRegionWiseList.GetCollectionRegionWise(pageIndex, GridView1.PageSize, inputCustomerCode.Value, inputCustomerName.Value, inputCustGroup.Value, inputYear.Value, Session["Division"].ToString(), inputRegion.Value, Session["Branch"].ToString(), inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            }
            //else if (User == FTD)
            //{
            //    GridView1.DataSource = CollectionReportRegionWiseList.GetCollectionRegionWise(pageIndex, GridView1.PageSize, inputCustomerCode.Value, inputCustomerName.Value, inputCustGroup.Value, inputYear.Value, "FEED TECH DIVISION", inputRegion.Value, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == PHD)
            //{
            //    GridView1.DataSource = CollectionReportRegionWiseList.GetCollectionRegionWise(pageIndex, GridView1.PageSize, inputCustomerCode.Value, inputCustomerName.Value, inputCustGroup.Value, inputYear.Value, "POULTRY HEALTH DIVISION", inputRegion.Value, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == SPD)
            //{
            //    GridView1.DataSource = CollectionReportRegionWiseList.GetCollectionRegionWise(pageIndex, GridView1.PageSize, inputCustomerCode.Value, inputCustomerName.Value, inputCustGroup.Value, inputYear.Value, "SPECIALITY PRODUCT DIVISION", inputRegion.Value, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == HHD)
            //{
            //    GridView1.DataSource = CollectionReportRegionWiseList.GetCollectionRegionWise(pageIndex, GridView1.PageSize, inputCustomerCode.Value, inputCustomerName.Value, inputCustGroup.Value, inputYear.Value, "HUMAN HEALTH DIVISION", inputRegion.Value, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == Mudassir)
            //{
            //    GridView1.DataSource = CollectionReportRegionWiseList.GetCollectionRegionWise(pageIndex, GridView1.PageSize, inputCustomerCode.Value, inputCustomerName.Value, inputCustGroup.Value, inputYear.Value, "FEED TECH DIVISION", inputRegion.Value,"KHO,HDC", inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == Amir)
            //{
            //    GridView1.DataSource = CollectionReportRegionWiseList.GetCollectionRegionWise(pageIndex, GridView1.PageSize, inputCustomerCode.Value, inputCustomerName.Value, inputCustGroup.Value, inputYear.Value, "POULTRY HEALTH DIVISION", inputRegion.Value,"KHO,HDC", inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == Arshad)
            //{
            //    GridView1.DataSource = CollectionReportRegionWiseList.GetCollectionRegionWise(pageIndex, GridView1.PageSize, inputCustomerCode.Value, inputCustomerName.Value, inputCustGroup.Value, inputYear.Value, "SPECIALITY PRODUCT DIVISION", inputRegion.Value, "KHO", inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            else
            {
                GridView1.DataSource = CollectionReportRegionWiseList.GetCollectionRegionWise(pageIndex, GridView1.PageSize, inputCustomerCode.Value, inputCustomerName.Value, inputCustGroup.Value, inputYear.Value, inputDivision.Value, inputRegion.Value, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            }
            GridView1.DataBind();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (Session["User"].ToString().ToUpper() != "ADMIN")
            {
                GridView1.DataSource = CollectionReportRegionWiseList.GetCollectionRegionWise(0, GridView1.PageSize, inputCustomerCode.Value, inputCustomerName.Value, inputCustGroup.Value, inputYear.Value, Session["Division"].ToString(), inputRegion.Value, Session["Branch"].ToString(), inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            }
            //else if (User == FTD)
            //{
            //    GridView1.DataSource = CollectionReportRegionWiseList.GetCollectionRegionWise(0, GridView1.PageSize, inputCustomerCode.Value, inputCustomerName.Value, inputCustGroup.Value, inputYear.Value, "FEED TECH DIVISION", inputRegion.Value, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
        ...
        protected void ExpToExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("content-disposition", "attachment; filename=CollectionReportRegionWise.xls");
        ...
        {
            {
                ...
                Response.AppendHeader("content-disposition",
                    "attachment;filename=CollectionReportRegionWise.pdf");
