<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DivisionWiseBalanceReport(PDC).aspx.cs" Inherits="GB_ASP.DivisionWiseBalanceReport_PDC_" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>DIVISION WISE BALANCE REPORT</title>
 ...
 <div id="wrapper" >
            ...
            <div class="container-fluid">
               <br />
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                          <div class="form-group">
                            <asp:ListBox ID="multiselect6" runat="server" AutoPostBack="false" SelectionMode="Multiple" OnSelectedIndexChanged="multiselect5_SelectedIndexChanged">
                                <asp:ListItem>PH1</asp:ListItem>
                                <asp:ListItem>PH2</asp:ListItem>
                                <asp:ListItem>PH3</asp:ListItem>
                                <asp:ListItem>PH4</asp:ListItem>
                                <asp:ListItem>PH5</asp:ListItem>
                                <asp:ListItem>PH6</asp:ListItem>
                                <asp:ListItem>PH7</asp:ListItem>
                              </asp:ListBox>
                              </div>
                    </div>
        ...
        <div class="panel panel-primary">
                <div class="panel-heading">
                    DIVISION WISE BALANCE REPORT (PDC)
                </div>
