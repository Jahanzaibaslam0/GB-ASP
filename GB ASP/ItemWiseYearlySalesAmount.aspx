<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemWiseYearlySalesAmount.aspx.cs" Inherits="GB_ASP.ItemWiseYearlySalesAmount1" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ITEM WISE YEARLY SALES AMOUNT</title>
 ...
 <div id="wrapper" >
               ...
               <br />
                ...
                <div class="row">
                    <input type="text" runat="server" Class="form-control" visible="false"
                                id="inputITEMID" placeholder="Item ID" />
                        
                         <input type="text" runat="server" Class="form-control" visible="false"
                                id="inputItemName" placeholder="Item Name" />
                    ...
                    <div class="col-md-3">
                          <div class="form-group">
                            <asp:ListBox ID="multiselect4" runat="server" AutoPostBack="false" SelectionMode="Multiple" OnSelectedIndexChanged="multiselect4_SelectedIndexChanged">
                                <asp:ListItem>TEAM A-FTD</asp:ListItem>
                                <asp:ListItem>TEAM B-FTD</asp:ListItem>
                                <asp:ListItem>TEAM C-FTD</asp:ListItem>
                                <asp:ListItem>TEAM A-PHD</asp:ListItem>
                                <asp:ListItem>TEAM B-PHD</asp:ListItem>
                                <asp:ListItem>TEAM A-AHD</asp:ListItem>
                                <asp:ListItem>TEAM B-AHD</asp:ListItem>
                                <asp:ListItem>TEAM A-HHD</asp:ListItem>
                                <asp:ListItem>TEAM B-HHD</asp:ListItem>
                                <asp:ListItem>TEAM C-HHD</asp:ListItem>
                              </asp:ListBox>
                              </div>
                    </div>
                    ...
                    <div class="col-md-3">
                          <div class="form-group">
                            <asp:ListBox ID="multiselect6" runat="server" AutoPostBack="false" SelectionMode="Multiple" OnSelectedIndexChanged="multiselect6_SelectedIndexChanged">
                                <asp:ListItem>LAHORE-FTD</asp:ListItem>
                                <asp:ListItem>GUJRANWALA-FTD</asp:ListItem>
                                <asp:ListItem>MULTAN-FTD</asp:ListItem>
                                <asp:ListItem>KARACHI-FTD</asp:ListItem>
                                <asp:ListItem>RAWALPINDI-FTD</asp:ListItem>
                                <asp:ListItem>FAISALABAD-PHD</asp:ListItem>
                                <asp:ListItem>LAHORE-PHD</asp:ListItem>
                                <asp:ListItem>GUJRANWALA-PHD</asp:ListItem>
                                <asp:ListItem>MULTAN-PHD</asp:ListItem>
                                <asp:ListItem>KARACHI-PHD</asp:ListItem>
                                <asp:ListItem>RAWALPINDI-PHD</asp:ListItem>
                                <asp:ListItem>KAMALIA-PHD</asp:ListItem>
                                <asp:ListItem>LAHORE 1-PHD</asp:ListItem>
                                <asp:ListItem>FAISALABAD-SPD</asp:ListItem>
                                <asp:ListItem>LAHORE-SPD</asp:ListItem>
                                <asp:ListItem>GUJRANWALA-SPD</asp:ListItem>
                                <asp:ListItem>MULTAN-SPD</asp:ListItem>
                                <asp:ListItem>KARACHI-SPD</asp:ListItem>
                                <asp:ListItem>HYDERABAD-SPD</asp:ListItem>
                                <asp:ListItem>RAWALPINDI-SPD</asp:ListItem>
                                <asp:ListItem>FAISALABAD-AHD</asp:ListItem>
                                <asp:ListItem>LAHORE-AHD</asp:ListItem>
                                <asp:ListItem>GUJRANWALA-AHD</asp:ListItem>
                                <asp:ListItem>MULTAN-AHD</asp:ListItem>
                                <asp:ListItem>KARACHI-AHD</asp:ListItem>
                                <asp:ListItem>HYDERABAD-AHD</asp:ListItem>
                                <asp:ListItem>RAWALPINDI-AHD</asp:ListItem>
                                <asp:ListItem>QUETTA-AHD</asp:ListItem>
                                <asp:ListItem>SUKKUR-AHD</asp:ListItem>
                                <asp:ListItem>NAWABSHAH-AHD</asp:ListItem>
                                <asp:ListItem>PESHAWAR-AHD</asp:ListItem>
                                <asp:ListItem>MULTAN-ACD</asp:ListItem>
                                <asp:ListItem>FAISALABAD-HHD</asp:ListItem>
                                <asp:ListItem>LAHORE-HHD</asp:ListItem>
                                <asp:ListItem>GUJRANWALA-HHD</asp:ListItem>
                                <asp:ListItem>MULTAN-HHD</asp:ListItem>
                                <asp:ListItem>KARACHI-HHD</asp:ListItem>
                                <asp:ListItem>HYDERABAD-HHD</asp:ListItem>
                                <asp:ListItem>RAWALPINDI-HHD</asp:ListItem>
                                <asp:ListItem>SUKKUR-HHD</asp:ListItem>
                                <asp:ListItem>PESHAWAR-HHD</asp:ListItem>
        ...
        <div class="panel panel-primary">
                <div class="panel-heading">
                    YEAR WISE ITEM SALES IN AMOUNT
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#multiselect1').multiselect({
                ...
                nonSelectedText: 'Select Item ID!',
        ...
        $(document).ready(function() {
            $('#multiselect3').multiselect({
                nonSelectedText: 'Select Item Name!',
