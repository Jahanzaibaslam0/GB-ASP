...
namespace GB_ASP
{
    public partial class CustomerWiseYearlySales : System.Web.UI.Page
    {
...
//                    multiselect6.DataTextField = "Division";
...
//                sqlConn6.Close();
        ...
        public void BindGrid()
        {
            ...
            foreach (System.Web.UI.WebControls.ListItem item in multiselect1.Items)
            {
                ...
                if (condition == "")
                {
                    inputCustomerID.Value = condition;
                    // TextBox1.Text = condition;
                }
                else
                {
                    inputCustomerID.Value = condition.Substring(0, condition.Length - 1);
                }
        ...
        private void DatabindRepeater(int pageIndex, int pageSize, int totalRows)
            ...
            {
                GridView1.DataSource = CustomerWiseYearlyAmount.GetCustomerWiseYearlySalesAmount(pageIndex, GridView1.PageSize, inputCustomerID.Value, inputCustomerName.Value, inputRegion.Value, Session["Division"].ToString(), Session["Branch"].ToString(), out totalRows);
            }
            //else if (User == FTD)
            //{
            //    GridView1.DataSource = CustomerWiseYearlyAmount.GetCustomerWiseYearlySalesAmount(pageIndex, GridView1.PageSize, inputCustomerID.Value, inputCustomerName.Value, inputRegion.Value, "FEED TECH DIVISION", inputBranch.Value, out totalRows);
            //}
            //else if (User == SPD)
            //{
            //    GridView1.DataSource = CustomerWiseYearlyAmount.GetCustomerWiseYearlySalesAmount(pageIndex, GridView1.PageSize, inputCustomerID.Value, inputCustomerName.Value, inputRegion.Value, "SPECIALITY PRODUCT DIVISION", inputBranch.Value, out totalRows);
            //}
            //else if (User == PHD)
            //{
            //    GridView1.DataSource = CustomerWiseYearlyAmount.GetCustomerWiseYearlySalesAmount(pageIndex, GridView1.PageSize, inputCustomerID.Value, inputCustomerName.Value, inputRegion.Value, "POULTRY HEALTH DIVISION", inputBranch.Value, out totalRows);
            //}
            //else if (User == HHD)
            //{
            //    GridView1.DataSource = CustomerWiseYearlyAmount.GetCustomerWiseYearlySalesAmount(pageIndex, GridView1.PageSize, inputCustomerID.Value, inputCustomerName.Value, inputRegion.Value, "HUMAN HEALTH DIVISION", inputBranch.Value, out totalRows);
            //}
            //else if (User == Mudassir)
            //{
            //    GridView1.DataSource = CustomerWiseYearlyAmount.GetCustomerWiseYearlySalesAmount(pageIndex, GridView1.PageSize, inputCustomerID.Value, inputCustomerName.Value, inputRegion.Value, "FEED TECH DIVISION","KHO,HDC", out totalRows);
            //}
            //else if (User == Amir)
            //{
            //    GridView1.DataSource = CustomerWiseYearlyAmount.GetCustomerWiseYearlySalesAmount(pageIndex, GridView1.PageSize, inputCustomerID.Value, inputCustomerName.Value, inputRegion.Value, "POULTRY HEALTH DIVISION","KHO,HDC", out totalRows);
            //}
            //else if (User == Arshad)
            //{
            //    GridView1.DataSource = CustomerWiseYearlyAmount.GetCustomerWiseYearlySalesAmount(pageIndex, GridView1.PageSize, inputCustomerID.Value, inputCustomerName.Value, inputRegion.Value, "SPECIALITY PRODUCT DIVISION", "KHO", out totalRows);
            //}
            else
                {
                    GridView1.DataSource = CustomerWiseYearlyAmount.GetCustomerWiseYearlySalesAmount(pageIndex, GridView1.PageSize, inputCustomerID.Value, inputCustomerName.Value, inputRegion.Value, inputDivision.Value, inputBranch.Value, out totalRows);
                }
                GridView1.DataBind();
            ...
            //GridView1.DataSource = EmployeeDataAccessLayer.GetEmployees(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
                if (Session["User"].ToString().ToUpper() != "ADMIN")
                {
                    GridView1.DataSource = CustomerWiseYearlyAmount.GetCustomerWiseYearlySalesAmount(0, GridView1.PageSize, inputCustomerID.Value, inputCustomerName.Value, inputRegion.Value, Session["Division"].ToString(), Session["Branch"].ToString(), out totalRows);
                }
                //else if (User == FTD)
                //{
                //    GridView1.DataSource = CustomerWiseYearlyAmount.GetCustomerWiseYearlySalesAmount(0, GridView1.PageSize, inputCustomerID.Value, inputCustomerName.Value, inputRegion.Value, "FEED TECH DIVISION", inputBranch.Value, out totalRows);
                //}
                //else if (User == SPD)
                //{
                //    GridView1.DataSource = CustomerWiseYearlyAmount.GetCustomerWiseYearlySalesAmount(0, GridView1.PageSize, inputCustomerID.Value, inputCustomerName.Value, inputRegion.Value, "SPECIALITY PRODUCT DIVISION", inputBranch.Value, out totalRows);
                //}
                //else if (User == PHD)
                //{
                //    GridView1.DataSource = CustomerWiseYearlyAmount.GetCustomerWiseYearlySalesAmount(0, GridView1.PageSize, inputCustomerID.Value, inputCustomerName.Value, inputRegion.Value, "POULTRY HEALTH DIVISION", inputBranch.Value, out totalRows);
                //}
                //else if (User == HHD)
                //{
                //    GridView1.DataSource = CustomerWiseYearlyAmount.GetCustomerWiseYearlySalesAmount(0, GridView1.PageSize, inputCustomerID.Value, inputCustomerName.Value, inputRegion.Value, "HUMAN HEALTH DIVISION", inputBranch.Value, out totalRows);
                //}
                //else if (User == Mudassir)
                //{
                //    GridView1.DataSource = CustomerWiseYearlyAmount.GetCustomerWiseYearlySalesAmount(0, GridView1.PageSize, inputCustomerID.Value, inputCustomerName.Value, inputRegion.Value, "FEED TECH DIVISION","KHO,HDC", out totalRows);
                //}
                //else if (User == Amir)
                //{
                //    GridView1.DataSource = CustomerWiseYearlyAmount.GetCustomerWiseYearlySalesAmount(0, GridView1.PageSize, inputCustomerID.Value, inputCustomerName.Value, inputRegion.Value, "POULTRY HEALTH DIVISION","KHO,HDC", out totalRows);
                //}
                //else if (User == Arshad)
                //{
                //    GridView1.DataSource = CustomerWiseYearlyAmount.GetCustomerWiseYearlySalesAmount(0, GridView1.PageSize, inputCustomerID.Value, inputCustomerName.Value, inputRegion.Value, "SPECIALITY PRODUCT DIVISION", "KHO", out totalRows);
                //}
                else
                {
                    GridView1.DataSource = CustomerWiseYearlyAmount.GetCustomerWiseYearlySalesAmount(0, GridView1.PageSize, inputCustomerID.Value, inputCustomerName.Value, inputRegion.Value, inputDivision.Value, inputBranch.Value, out totalRows);
                }
                GridView1.DataBind();
            ...
            protected void ExpToExcel_Click(object sender, EventArgs e)
            {
                ...
                Response.AppendHeader("content-disposition", "attachment; filename=CustomerWiseYearlySales.xls");
            ...
            {
                {
                    ...
                    Response.AppendHeader("content-disposition",
                        "attachment;filename=CustomerWiseYearlySales.pdf");
