...
namespace GB_ASP
{
    public partial class DivisionWiseBalanceReport_PDC_ : System.Web.UI.Page
    {
        ...
        public void BindGrid6()
        {
            ...
            foreach (System.Web.UI.WebControls.ListItem item in multiselect6.Items)
            {
                ...
                if (condition == "")
                {
                    inputCompany.Value = condition;
                    // TextBox1.Text = condition;
                }
                else
                {
                    inputCompany.Value = condition.Substring(0, condition.Length - 1);
                }
...

        {
            ...
            {
                  GridView1.DataSource = DivisionWiseBalanceList.GetDivisionWiseBalanceReport(pageIndex, GridView1.PageSize, inputCompany.Value, inputCustomerCode.Value, inputCustomerName.Value, inputGroup.Value, Session["Branch"].ToString(), Session["Division"].ToString(), out totalRows);
            }
            //else if (User == PHD)
            //{
            //    GridView1.DataSource = DivisionWiseBalanceList.GetDivisionWiseBalanceReport(pageIndex, GridView1.PageSize, inputCompany.Value, inputCustomerCode.Value, inputCustomerName.Value, inputGroup.Value, inputBranch.Value, "POULTRY HEALTH DIVISION", out totalRows);
            //}
            //else if (User == SPD)
            //{
            //    GridView1.DataSource = DivisionWiseBalanceList.GetDivisionWiseBalanceReport(pageIndex, GridView1.PageSize, inputCompany.Value, inputCustomerCode.Value, inputCustomerName.Value, inputGroup.Value, inputBranch.Value, "SPECIALITY PRODUCT DIVISION", out totalRows);
            //}
            //else if (User == HHD)
            //{
            //    GridView1.DataSource = DivisionWiseBalanceList.GetDivisionWiseBalanceReport(pageIndex, GridView1.PageSize, inputCompany.Value, inputCustomerCode.Value, inputCustomerName.Value, inputGroup.Value, inputBranch.Value, "HUMAN HEALTH DIVISION", out totalRows);
            //}
            //else if (User == FTD)
            //{
            //    GridView1.DataSource = DivisionWiseBalanceList.GetDivisionWiseBalanceReport(pageIndex, GridView1.PageSize, inputCompany.Value, inputCustomerCode.Value, inputCustomerName.Value, inputGroup.Value, inputBranch.Value, "FEED TECH DIVISION", out totalRows);
            //}
            //else if (User == Mudassir)
            //{
            //    GridView1.DataSource = DivisionWiseBalanceList.GetDivisionWiseBalanceReport(pageIndex, GridView1.PageSize, inputCompany.Value, inputCustomerCode.Value, inputCustomerName.Value, inputGroup.Value,"KHO,HDC", "FEED TECH DIVISION", out totalRows);
            //}
            //else if (User == Amir)
            //{
            //    GridView1.DataSource = DivisionWiseBalanceList.GetDivisionWiseBalanceReport(pageIndex, GridView1.PageSize, inputCompany.Value, inputCustomerCode.Value, inputCustomerName.Value, inputGroup.Value,"KHO,HDC", "POULTRY HEALTH DIVISION", out totalRows);
            //}
            //else if (User == Arshad)
            //{
            //    GridView1.DataSource = DivisionWiseBalanceList.GetDivisionWiseBalanceReport(pageIndex, GridView1.PageSize, inputCompany.Value, inputCustomerCode.Value, inputCustomerName.Value, inputGroup.Value, "KHO", "SPECIALITY PRODUCT DIVISION", out totalRows);
            //}
            else
            {
                GridView1.DataSource = DivisionWiseBalanceList.GetDivisionWiseBalanceReport(pageIndex, GridView1.PageSize, inputCompany.Value, inputCustomerCode.Value, inputCustomerName.Value, inputGroup.Value, inputBranch.Value, inputDivision.Value, out totalRows);
            }
            GridView1.DataBind();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (Session["User"].ToString().ToUpper() != "ADMIN")
            {
                GridView1.DataSource = DivisionWiseBalanceList.GetDivisionWiseBalanceReport(0, GridView1.PageSize, inputCompany.Value, inputCustomerCode.Value, inputCustomerName.Value, inputGroup.Value, Session["Branch"].ToString(), Session["Division"].ToString(), out totalRows);
            }
            //else if (User == PHD)
            //{
            //    GridView1.DataSource = DivisionWiseBalanceList.GetDivisionWiseBalanceReport(0, GridView1.PageSize, inputCompany.Value, inputCustomerCode.Value, inputCustomerName.Value, inputGroup.Value, inputBranch.Value, "POULTRY HEALTH DIVISION", out totalRows);
            //}
            //else if (User == SPD)
            //{
            //    GridView1.DataSource = DivisionWiseBalanceList.GetDivisionWiseBalanceReport(0, GridView1.PageSize, inputCompany.Value, inputCustomerCode.Value, inputCustomerName.Value, inputGroup.Value, inputBranch.Value, "SPECIALITY PRODUCT DIVISION", out totalRows);
            //}
            //else if (User == HHD)
            //{
            //    GridView1.DataSource = DivisionWiseBalanceList.GetDivisionWiseBalanceReport(0, GridView1.PageSize, inputCompany.Value, inputCustomerCode.Value, inputCustomerName.Value, inputGroup.Value, inputBranch.Value, "HUMAN HEALTH DIVISION", out totalRows);
            //}
            //else if (User == FTD)
            //{
            //    GridView1.DataSource = DivisionWiseBalanceList.GetDivisionWiseBalanceReport(0, GridView1.PageSize, inputCompany.Value, inputCustomerCode.Value, inputCustomerName.Value, inputGroup.Value, inputBranch.Value, "FEED TECH DIVISION", out totalRows);
            //}
            //else if (User == Mudassir)
            //{
            //    GridView1.DataSource = DivisionWiseBalanceList.GetDivisionWiseBalanceReport(0, GridView1.PageSize, inputCompany.Value, inputCustomerCode.Value, inputCustomerName.Value, inputGroup.Value,"KHO,HDC", "FEED TECH DIVISION", out totalRows);
            //}
            //else if (User == Amir)
            //{
            //    GridView1.DataSource = DivisionWiseBalanceList.GetDivisionWiseBalanceReport(0, GridView1.PageSize, inputCompany.Value, inputCustomerCode.Value, inputCustomerName.Value, inputGroup.Value,"KHO,HDC", "POULTRY HEALTH DIVISION", out totalRows);
            //}
            //else if (User == Arshad)
            //{
            //    GridView1.DataSource = DivisionWiseBalanceList.GetDivisionWiseBalanceReport(0, GridView1.PageSize, inputCompany.Value, inputCustomerCode.Value, inputCustomerName.Value, inputGroup.Value, "KHO", "SPECIALITY PRODUCT DIVISION", out totalRows);
            //}
            else
            {
                GridView1.DataSource = DivisionWiseBalanceList.GetDivisionWiseBalanceReport(0, GridView1.PageSize, inputCompany.Value, inputCustomerCode.Value, inputCustomerName.Value, inputGroup.Value, inputBranch.Value, inputDivision.Value, out totalRows);
            }
        ...
        protected void ExpToExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("content-disposition", "attachment; filename=DivisionWiseBalanceReportPDC.xls");
        ...
        {
            {
                ...
                Response.AppendHeader("content-disposition",
                    "attachment;filename=DivisionWiseBalanceReportPDC.pdf");
