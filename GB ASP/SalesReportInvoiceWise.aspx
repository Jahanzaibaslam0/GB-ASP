<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesReportInvoiceWise.aspx.cs" Inherits="GB_ASP.SalesReportInvoiceWise" %>
               ...
               <br />
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                         ...
                         <input type="text" runat="server" Class="form-control"
                                id="inputBranch" placeholder="Branch" visible="false" />
