...
namespace GB_ASP
{
    public partial class CustomerWiseSalesQty1 : System.Web.UI.Page
    {
        ...
        private void DatabindRepeater(int pageIndex, int pageSize, int totalRows)
            ...
            //GridView1.DataSource = EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
                ...
                {
                    GridView1.DataSource = CustomerWiseSalesQty.GetCustomerWiseSalesQty(pageIndex, GridView1.PageSize,inputStartInvoiceDate.Value,inputEndInvoiceDate.Value,inputCustomer.Value,inputCustName.Value, inputITEMID.Value, inputItemName.Value, inputRegion.Value, Session["Division"].ToString(), Session["Branch"].ToString(), out totalRows);
                }
                //else if (User == FTD)
                //{
                //    GridView1.DataSource = CustomerWiseSalesQty.GetCustomerWiseSalesQty(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomer.Value, inputCustName.Value, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "FEED TECH DIVISION", inputBranch.Value, out totalRows);
                //}
                //else if (User == SPD)
                //{
                ...
                //else if (User == PHD)
                //{
                //    GridView1.DataSource = CustomerWiseSalesQty.GetCustomerWiseSalesQty(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomer.Value, inputCustName.Value, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "POULTRY HEALTH DIVISION", inputBranch.Value, out totalRows);
                //}
                //else if (User == HHD)
                //{
                //    GridView1.DataSource = CustomerWiseSalesQty.GetCustomerWiseSalesQty(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomer.Value, inputCustName.Value, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "HUMAN HEALTH DIVISION", inputBranch.Value, out totalRows);
                //}
                //else if (User == Mudassir)
                //{
                //    GridView1.DataSource = CustomerWiseSalesQty.GetCustomerWiseSalesQty(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomer.Value, inputCustName.Value, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "FEED TECH DIVISION","KHO,HDC", out totalRows);
                //}
                //else if (User == Amir)
                //{
                //    GridView1.DataSource = CustomerWiseSalesQty.GetCustomerWiseSalesQty(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomer.Value, inputCustName.Value, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "POULTRY HEALTH DIVISION","KHO,HDC", out totalRows);
                //}
                //else if (User == Arshad)
                //{
                //    GridView1.DataSource = CustomerWiseSalesQty.GetCustomerWiseSalesQty(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomer.Value, inputCustName.Value, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "SPECIALITY PRODUCT DIVISION", "KHO", out totalRows);
                //}
                else
                {
                    GridView1.DataSource = CustomerWiseSalesQty.GetCustomerWiseSalesQty(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomer.Value, inputCustName.Value, inputITEMID.Value, inputItemName.Value, inputRegion.Value, inputDivision.Value, inputBranch.Value, out totalRows);
                }
                GridView1.DataBind();
            ...
            {
                GridView1.DataSource = CustomerWiseSalesQty.GetCustomerWiseSalesQty(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomer.Value, inputCustName.Value, inputITEMID.Value, inputItemName.Value, inputRegion.Value, Session["Division"].ToString(), Session["Branch"].ToString(), out totalRows);
            }
            //else if (User == FTD)
            //    {
            //        GridView1.DataSource = CustomerWiseSalesQty.GetCustomerWiseSalesQty(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomer.Value, inputCustName.Value, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "FEED TECH DIVISION", inputBranch.Value, out totalRows);
            //    }
            //    else if (User == SPD)
            //    {
            //        GridView1.DataSource = CustomerWiseSalesQty.GetCustomerWiseSalesQty(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomer.Value, inputCustName.Value, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "SPECIALITY PRODUCT DIVISION", inputBranch.Value, out totalRows);
            //    }
            //    else if (User == PHD)
            //    {
            //        GridView1.DataSource = CustomerWiseSalesQty.GetCustomerWiseSalesQty(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomer.Value, inputCustName.Value, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "POULTRY HEALTH DIVISION", inputBranch.Value, out totalRows);
            //    }
            //    else if (User == HHD)
            //    {
            //        GridView1.DataSource = CustomerWiseSalesQty.GetCustomerWiseSalesQty(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomer.Value, inputCustName.Value, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "HUMAN HEALTH DIVISION", inputBranch.Value, out totalRows);
            //    }
            //    else if (User == Mudassir)
            //    {
            //        GridView1.DataSource = CustomerWiseSalesQty.GetCustomerWiseSalesQty(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomer.Value, inputCustName.Value, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "FEED TECH DIVISION","KHO,HDC", out totalRows);
            //    }
            //    else if (User == Amir)
            //    {
            //        GridView1.DataSource = CustomerWiseSalesQty.GetCustomerWiseSalesQty(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomer.Value, inputCustName.Value, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "POULTRY HEALTH DIVISION","KHO,HDC", out totalRows);
            //    }
            //    else if (User == Arshad)
            //    {
            //        GridView1.DataSource = CustomerWiseSalesQty.GetCustomerWiseSalesQty(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomer.Value, inputCustName.Value, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "SPECIALITY PRODUCT DIVISION", "KHO", out totalRows);
            //    }
                else
                {
                    GridView1.DataSource = CustomerWiseSalesQty.GetCustomerWiseSalesQty(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomer.Value, inputCustName.Value, inputITEMID.Value, inputItemName.Value, inputRegion.Value, inputDivision.Value, inputBranch.Value, out totalRows);
            ...
            protected void ExpToExcel_Click(object sender, EventArgs e)
            {
                ...
                Response.AppendHeader("content-disposition", "attachment; filename=ItemWiseYearlySaleAmount.xls");
            ...
            {
                {
                    ...
                    Response.AppendHeader("content-disposition",
                        "attachment;filename=CustomerWiseSalesQty.pdf");
