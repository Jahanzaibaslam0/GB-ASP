...
namespace GB_ASP
{
    public partial class CustomerAgingConsolidated : System.Web.UI.Page
    {
...

        {
            ...
            //else if (User == Arshad)
            //{
            //    GridView1.DataSource = CustomerAgingConsolidatedList.GetCustomerAgingConsolidated(pageIndex, GridView1.PageSize, inputCustomerCode.Value, inputCustomerName.Value, "KHO", out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);

            //}
            else
            {
                GridView1.DataSource = CustomerAgingConsolidatedList.GetCustomerAgingConsolidated(pageIndex, GridView1.PageSize, inputCustomerCode.Value, inputCustomerName.Value,inputBranch.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (Session["User"].ToString().ToUpper() != "ADMIN")
            { 
                GridView1.DataSource = CustomerAgingConsolidatedList.GetCustomerAgingConsolidated(0, GridView1.PageSize, inputCustomerCode.Value, inputCustomerName.Value, Session["Branch"].ToString(), out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            }
        ...
        protected void ExpToExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("content-disposition", "attachment; filename=CUSTOMERAGINGCONSOLIDATEDREPORT.xls");
        ...
        {
            {
                ...
                Response.AppendHeader("content-disposition",
                    "attachment;filename=CUSTOMERAGINGCONSOLIDATEDREPORT.pdf");
