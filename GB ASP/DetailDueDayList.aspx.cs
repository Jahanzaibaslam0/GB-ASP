...
namespace GB_ASP
{
    public partial class DetailDueDayList1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Session["User"] != null)
                {
                    ...
                    //{
                    //    multiselect5.Visible = false;
                    //    multiselect7.Visible = false;
                    //}
        ...
        public void BindGrid4()
        {
            ...
            foreach (System.Web.UI.WebControls.ListItem item in multiselect4.Items)
            {
                ...
                if (condition == "")
                {
                    inputEmployee.Value = condition;
                    // TextBox1.Text = condition;
                }
                else
                {
                    inputEmployee.Value = condition.Substring(0, condition.Length - 1);
                }
...

        {
            ...
            { 
            GridView1.DataSource = DetailDueDayList.GetDetailDueDayList(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value,inputCustomerName.Value, inputCustGroup.Value, Session["Division"].ToString(), Session["Region"].ToString(), inputEmployee.Value, Session["Branch"].ToString(), out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            }
            //else if (User == FTD)
            //{
            //    GridView1.DataSource = DetailDueDayList.GetDetailDueDayList(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value,inputCustomerName.Value, inputCustGroup.Value, "FEED TECH DIVISION", inputRegion.Value, inputEmployee.Value, inputBranch.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == PHD)
            //{
            //    GridView1.DataSource = DetailDueDayList.GetDetailDueDayList(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value,inputCustomerName.Value, inputCustGroup.Value, "POULTRY HEALTH DIVISION", inputRegion.Value, inputEmployee.Value, inputBranch.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == SPD)
            //{
            //    GridView1.DataSource = DetailDueDayList.GetDetailDueDayList(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value,inputCustomerName.Value, inputCustGroup.Value, "SPECIALITY PRODUCT DIVISION", inputRegion.Value, inputEmployee.Value, inputBranch.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == HHD)
            //{
            //    GridView1.DataSource = DetailDueDayList.GetDetailDueDayList(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value,inputCustomerName.Value, inputCustGroup.Value, "HUMAN HEALTH DIVISION", inputRegion.Value, inputEmployee.Value, inputBranch.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == Mudassir)
            //{
            //    GridView1.DataSource = DetailDueDayList.GetDetailDueDayList(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value,inputCustomerName.Value, inputCustGroup.Value, "FEED TECH DIVISION", inputRegion.Value, inputEmployee.Value,"KHO,HDC", out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == Amir)
            //{
            //    GridView1.DataSource = DetailDueDayList.GetDetailDueDayList(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value,inputCustomerName.Value, inputCustGroup.Value, "POULTRY HEALTH DIVISION", inputRegion.Value, inputEmployee.Value,"KHO,HDC", out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            ...
            {
                GridView1.DataSource = DetailDueDayList.GetDetailDueDayList(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value,inputCustomerName.Value, inputCustGroup.Value, inputDivision.Value, inputRegion.Value, inputEmployee.Value, inputBranch.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            }
            GridView1.DataBind();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            //else if (User == AHD)
            //{
            //    GridView1.DataSource = DetailDueDayList.GetDetailDueDayList(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value,inputCustomerName.Value, inputCustGroup.Value,"ANIMAL HEALTH DIVISION", inputRegion.Value, inputEmployee.Value, inputBranch.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == HHD)
            //{
            //    GridView1.DataSource = DetailDueDayList.GetDetailDueDayList(0, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCustomerCode.Value,inputCustomerName.Value, inputCustGroup.Value,"HUMAN HEALTH DIVISION", inputRegion.Value, inputEmployee.Value, inputBranch.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
        ...
        protected void ExpToExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("content-disposition", "attachment; filename=DetailDueDayList.xls");
        ...
        {
            {
                ...
                Response.AppendHeader("content-disposition",
                    "attachment;filename=DetailDueDayList.pdf");
