...
namespace GB_ASP
{
    public partial class ItemWiseYearlySaleQty : System.Web.UI.Page
    {
...

        {
            ...
            string User = Session["User"].ToString().ToString();
            ...
            {
                GridView1.DataSource = ItemWiseYearlySalesQty.GetItemWiseYearlySalesQty(pageIndex, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, Session["Division"].ToString(),inputTeam.Value, out totalRows);
            }
            //if (User == FTD)
            //{
            //    GridView1.DataSource = ItemWiseYearlySalesQty.GetItemWiseYearlySalesQty(pageIndex, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "FEED TECH DIVISION", inputTeam.Value, out totalRows);
            //}
            //if (User == SPD)
            //{
            //    GridView1.DataSource = ItemWiseYearlySalesQty.GetItemWiseYearlySalesQty(pageIndex, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "SPECIALITY PRODUCT DIVISION", inputTeam.Value, out totalRows);
            //}
            //if (User == PHD)
            //{
            //    GridView1.DataSource = ItemWiseYearlySalesQty.GetItemWiseYearlySalesQty(pageIndex, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "POULTRY HEALTH DIVISION", inputTeam.Value, out totalRows);
            //}
            //if (User == HHD)
            //{
            //    GridView1.DataSource = ItemWiseYearlySalesQty.GetItemWiseYearlySalesQty(pageIndex, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "HUMAN HEALTH DIVISION", inputTeam.Value, out totalRows);
            //}
            else
            {
                GridView1.DataSource = ItemWiseYearlySalesQty.GetItemWiseYearlySalesQty(pageIndex, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, inputDivision.Value, inputTeam.Value, out totalRows);
            }
            GridView1.DataBind();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (Session["User"].ToString().ToUpper() != "ADMIN")
            {
                GridView1.DataSource = ItemWiseYearlySalesQty.GetItemWiseYearlySalesQty(0, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, Session["Division"].ToString(), inputTeam.Value, out totalRows);
            }
            //if (User == FTD)
            //{
            //    GridView1.DataSource = ItemWiseYearlySalesQty.GetItemWiseYearlySalesQty(0, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "FEED TECH DIVISION", inputTeam.Value, out totalRows);
            //}
            //if (User == SPD)
            //{
            //    GridView1.DataSource = ItemWiseYearlySalesQty.GetItemWiseYearlySalesQty(0, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "SPECIALITY PRODUCT DIVISION", inputTeam.Value, out totalRows);
            //}
            //if (User == PHD)
            //{
            //    GridView1.DataSource = ItemWiseYearlySalesQty.GetItemWiseYearlySalesQty(0, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "POULTRY HEALTH DIVISION", inputTeam.Value, out totalRows);
            //}
            //if (User == HHD)
            //{
            //    GridView1.DataSource = ItemWiseYearlySalesQty.GetItemWiseYearlySalesQty(0, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, "HUMAN HEALTH DIVISION", inputTeam.Value, out totalRows);
            //}
            else
            {
                GridView1.DataSource = ItemWiseYearlySalesQty.GetItemWiseYearlySalesQty(0, GridView1.PageSize, inputITEMID.Value, inputItemName.Value, inputRegion.Value, inputDivision.Value, inputTeam.Value, out totalRows);
        ...
        protected void ExpToExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("content-disposition", "attachment; filename=ItemWiseYearlySaleQty.xls");
        ...
        {
            {
                ...
                Response.AppendHeader("content-disposition",
                    "attachment;filename=ItemWiseYearlySaleQty.pdf");
