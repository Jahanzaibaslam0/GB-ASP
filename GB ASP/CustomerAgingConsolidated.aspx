<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerAgingConsolidated.aspx.cs" Inherits="GB_ASP.CustomerAgingConsolidated" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CUSTOMER AGING CONSOLIDATED</title>
 ...
 <div id="wrapper" >
            ...
            <div class="container-fluid">
               <br />
                ...
                <div class="row">
                  ...
                  <div class="form-group">
                         <input type="text" runat="server" Class="form-control"
                                id="inputEmployee" placeholder="Order Taker Name" />
                        </div>
                        </div>
        ...
        <div class="panel panel-primary">
                <div class="panel-heading">
                    CUSTOMER AGING CONSOLIDATED REPORT
                </div>
