...
namespace GB_ASP
{
    public partial class OpenSalesOrderForCustomerOnHold : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string query4 = @"select distinct s.CREATEDBY
                from (SALESTABLE s
                LEFT JOIN  CONTACTPERSON c ON s.CONTACTPERSONID = c.CONTACTPERSONID) 
                LEFT JOIN DIRPARTYTABLE d ON c.PARTY = d.RECID
                where  s.DATAAREAID = 'ph1'";
                ...
                if (sdr4.HasRows)
                {
                    ...
                    multiselect4.DataTextField = "CREATEDBY";
                ...
                string query7 = @"select Distinct c.InventLocationBr from CUSTTABLE c where c.DATAAREAID = 'ph1' and InventLocationBr in (" + Branch1 + ")";
                ...
                if (sdr7.HasRows)
                {
                    ...
                    multiselect7.DataTextField = "InventLocationBr";
        ...
        public void BindGrid4()
        {
            ...
            foreach (System.Web.UI.WebControls.ListItem item in multiselect4.Items)
            {
                ...
                if (condition == "")
                {
                    inputCretedBy.Value = condition;
                    // TextBox1.Text = condition;
                }
                else
                {
                    inputCretedBy.Value = condition.Substring(0, condition.Length - 1);
                }
...

        {
            ...
            string Status = Convert.ToString("1");
            string Row = Convert.ToString("1");
            string hold = Convert.ToString("2");
            string AHD = "AHD";
            string SPD = "SPD";
            string FTD = "FTD";
            string PHD = "PHD";
            ...
            //GridView1.DataSource = spCustomer.(pageIndex, GridView1.PageSize,inp , out totalRows);
            if (Session["User"].ToString().ToUpper() != "ADMIN")
            {
                GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(pageIndex, GridView1.PageSize, Status, hold,Session["Branch"].ToString(), inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, Session["Division"].ToString(), inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            }
            //else if (User == FTD)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(pageIndex, GridView1.PageSize, Status, hold, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "FEED TECH DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == PHD)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(pageIndex, GridView1.PageSize, Status, hold, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "POULTRY HEALTH DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == SPD)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(pageIndex, GridView1.PageSize, Status, hold, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "SPECIALITY PRODUCT DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == HHD)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(pageIndex, GridView1.PageSize, Status, hold, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "HUMAN HEALTH DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == Mudassir)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(pageIndex, GridView1.PageSize, Status, hold, "KHO,HDC", inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "FEED TECH DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == Amir)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(pageIndex, GridView1.PageSize, Status, hold, "KHO,HDC", inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "POULTRY HEALTH DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            //else if (User == Arshad)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(pageIndex, GridView1.PageSize, Status, hold, "KHO", inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "SPECIALITY PRODUCT DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            //}
            else
            {
                GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(pageIndex, GridView1.PageSize, Status, hold, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, inputDivision.Value, inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            }
            GridView1.DataBind();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (Session["User"].ToString().ToUpper() != "ADMIN")
            {
                GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(0, GridView1.PageSize, Status, hold, Session["Branch"].ToString(), inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, Session["Division"].ToString(), inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmployees(pageIndex, GridView1.PageSize, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputProductCode.Value, inputProductName.Value, inputDivision.Value, inputRegion.Value, out totalRows);
            }
            //else if (User == FTD)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(0, GridView1.PageSize, Status, hold, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "FEED TECH DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmp;
            //}
            //else if (User == PHD)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(0, GridView1.PageSize, Status, hold, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "POULTRY HEALTH DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GRows);
            //}
            //else if (User == SPD)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(0, GridView1.PageSize, Status, hold, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "SPECIALITY PRODUCT DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayotalRows);
            //}
            //else if (User == HHD)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(0, GridView1.PageSize, Status, hold, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "HUMAN HEALTH DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.Getws);
            //}
            
            //else if (User == Mudassir)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(0, GridView1.PageSize, Status, hold,"KHO,HDC", inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "FEED TECH DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.Geows);
            //}
            //else if (User == Amir)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(0, GridView1.PageSize, Status, hold, "KHO,HDC", inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "POULTRY HEALTH DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayotalRows);
            ...
            //else if (User == Arshad)
            //{
            //    GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(0, GridView1.PageSize, Status, hold, "KHO", inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, "SPECIALITY PRODUCT DIVISION", inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmploy
            //}
            else
            {
                GridView1.DataSource = SalesOrderClass.GetAllSalesOrder(0, GridView1.PageSize, Status, hold, inputBranch.Value, inputStartInvoiceDate.Value, inputEndInvoiceDate.Value, inputCretedBy.Value, inputCustomerCode.Value, inputCustomerName.Value, inputSalesOrder.Value, inputDivision.Value, inputRegion.Value, out totalRows);//EmployeeDataAccessLayer.GetEmpl
            }
            GridView1.DataBind();
        ...
        protected void ExpToExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AppendHeader("content-disposition", "attachment; filename=OPENSALESORDERFORCUSTOMERONHOLD.xls");
        ...
        {
            {
                ...
                Response.AppendHeader("content-disposition",
                    "attachment;filename=OPENSALESORDERFORCUSTOMERONHOLD.pdf");
