<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InternalAccountStatement.aspx.cs" Inherits="GB_ASP.InternalAccountStatement1" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>INTERNAL ACCOUNT STATEMENT</title>
 ...
 <div id="wrapper" >
            ...
            <div class="container-fluid">
               <br />
                ...
                <div class="row">
                        ...
                        <input type="text" runat="server" Class="form-control" visible="false"
                                id="inputBranch" placeholder="Branch" />
        ...
        <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <br />
                    <div class="a">
            <h3>CUSTOMER ACCOUNT DETAIL</h3>
            <div class="table-responsive">  
            <asp:GridView ID="GridView1" CssClass="table table-bordered" Visible="true" runat="server" AllowPaging="True" BackColor="White" PagerSettings-FirstPageText="First" PagerSettings-Mode="NumericFirstLast" PagerSettings-LastPageText="Last" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" PageSize="10">
            ...
            <asp:Repeater ID="RepeaterPaging" runat="server" OnItemCommand="RepeaterPaging_ItemCommand">
                <ItemTemplate>
                    ...
                    <%--<asp:LinkButton ID="LinkButton" runat="server"
                        ...
                        <h3>POST DATED CHEQUES DETAILS</h3>

            <div class="table-responsive">  
            <asp:GridView ID="GridView2" CssClass="table table-bordered" Visible="true" runat="server" AllowPaging="True" BackColor="White" PagerSettings-FirstPageText="First" PagerSettings-Mode="NumericFirstLast" PagerSettings-LastPageText="Last" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" PageSize="10">
                <FooterStyle BackColor="#99CCCC" ForeColor="#003399" />
                <HeaderStyle BackColor="#003399" Font-Bold="True" ForeColor="#CCCCFF" />
                <PagerSettings FirstPageText="First" LastPageText="Last" />
                <PagerStyle ForeColor="#003399" HorizontalAlign="Left" BackColor="#99CCCC" />
            ...
            <asp:Repeater ID="Repeater2" runat="server" OnItemCommand="RepeaterPaging_ItemCommand">
                <ItemTemplate>
                    ...
                    <%--<asp:LinkButton ID="LinkButton" runat="server"
                        ...
                        <h3>CUSTOEMR ACCOUNT SUMMARY</h3>

                        <div class="table-responsive">  
            <asp:GridView ID="GridView3" CssClass="table table-bordered" Visible="true" runat="server" AllowPaging="True" BackColor="White" PagerSettings-FirstPageText="First" PagerSettings-Mode="NumericFirstLast" PagerSettings-LastPageText="Last" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" PageSize="10">
                <FooterStyle BackColor="#99CCCC" ForeColor="#003399" />
                <HeaderStyle BackColor="#003399" Font-Bold="True" ForeColor="#CCCCFF" />
                <PagerSettings FirstPageText="First" LastPageText="Last" />
                <PagerStyle ForeColor="#003399" HorizontalAlign="Left" BackColor="#99CCCC" />
            ...
            <asp:Repeater ID="Repeater3" runat="server" OnItemCommand="RepeaterPaging_ItemCommand">
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton1" runat="server"
                        Text='<%#Eval("Text") %>'
                        CommandArgument='<%#Eval("Value") %>'
