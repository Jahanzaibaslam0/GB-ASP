<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OpenReturnOrder.aspx.cs" Inherits="GB_ASP.OpenReturnOrder" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>OPEN RETURN ORDER</title>
                ...
                <div class="row">
                  ...
                  <div class="form-group">
                         <input type="text" runat="server" Class="form-control"
                                id="inputSalesID" placeholder="Sales Order ID" />
                        </div>
                        </div>
                         ...
                         <input type="text" runat="server" Class="form-control" visible="false"
                                id="inputSalesTaker" placeholder="SalesTaker" />
     ...
     <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('#multiselect4').multiselect({
                nonSelectedText: 'Select Sales Taker!',
